...
HWND inputMove;
HWND checkCaesar, checkEncode, checkDecode, checkFile;
HWND buttonGo;
...
HRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wparam, LPARAM lparam) {
	...
	int columnButtonGo = columnInputString + 500;
	...
	case WM_CREATE: {
		...
		inputMove   = CreateWindow(L"EDIT"  , L"4"      , WS_VISIBLE | WS_BORDER | WS_CHILD                                , columnInputMove      , rowInputMove      , 90, 20, hwnd, (HMENU)3, NULL, NULL);
		...
		checkCaesar = CreateWindow(L"BUTTON", L"Caesar" , WS_VISIBLE | WS_BORDER | WS_CHILD | BS_AUTORADIOBUTTON | WS_GROUP, columnInputMove      , rowInputMove + 60 , 90, 20, hwnd, (HMENU)6, NULL, NULL);
